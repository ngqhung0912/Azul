...
public class PlayerFloorViewTest extends ApplicationTest {
    ...
    @Test
    void floorTileGridIsDisplayed() {
        verifyThat("#floorGridPane", isVisible());
    }

    @Test
    void correctNumberOfFloorTileLabelsAreDisplayed() {
    ...
    @Test
    void correctNumberOfFloorTileBoxesAreDisplayed() {
    ...
    @Test
    void floorTileLabelsDisplayCorrectNegativePoints() {
